...
При $n = 4$: $P = 1 - (1 - 0.05)^{4} = `r format(round(1 - (1 - 0.05)^4, 2), nsmall = 2)`$    

При $n = 10$: $P = 1 - (1 - 0.05)^{10} = `r format(round(1 - (1 - 0.05)^10, 2), nsmall = 2)`$    

При $n = 100$: $P = 1 - (1 - 0.05)^{100} = `r format(round(1 - (1 - 0.05)^100, 2), nsmall = 2)`$    
