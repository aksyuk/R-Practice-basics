...
`r fa_chart_bar(color = "#1E8449")` можно собрать любой статический график с нуля   

`r fa_chart_line(color = "#1E8449")` результат сложно сохранить как объект   
...
- Элементы добавляются на активный график функциями низкого уровня: `points()`, `abline()`, `axis()`, `text()` и др.  
